    ...
    <div className="split-panels">
      <section>
        <div className="panel-heading">
          <div>
            <p className="eyebrow">Company footprint</p>
            <h2>Branches</h2>
          </div>
        ...
        <form className="compact-form" onSubmit={addBranch}>
          ...
          />
          <Button disabled={mutate.isPending}>Add branch</Button>
        </form>
      ...
      <section>
        <div className="panel-heading">
          <div>
            <p className="eyebrow">Reporting structure</p>
            <h2>Departments</h2>
          </div>
        ...
        <form className="compact-form" onSubmit={addDepartment}>
          ...
          <Button disabled={mutate.isPending}>Add department</Button>
        </form>
        <div className="record-list">
